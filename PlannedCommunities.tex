...
\begin{document}
	...
	\SetWatermarkText{
		\includegraphics[angle=-45]{images/cover.pdf}
	}
	...
	\section{Summary}
		...
		For every city I examined, how it was planned, how it developed since its foundation and how the city looks today.
	...
	\begin{multicols}{2}		
		\raggedcolumns
			...
			The rest of the planned rail network [Fig \ref{fig:map:abuja-rail-network-2019}] is yet outstanding. The national trains arrive at the main station outside of Abuja, but do not get yet to the city center.
	...
	- Cities developed in the pedestrian and streetcar era preserved their design in the center - and sprawled out in 1950
	- open plan supports development following the plan
	- Natural boundaries or growth boundaries support compact development
	- Government intervention is necessary - without restriction - sprawl development occurs
	- Public transport must be there before the development
	
	A successful sustainable city plan should
	- be an open pattern
	- have compact, mixed-use design
	- contain growth boundaries (max limit)
	- Not only reserve space for transportation infrastructure - it must already be included
	- Government must be strong enough, to restrict development outside the growth boundary
