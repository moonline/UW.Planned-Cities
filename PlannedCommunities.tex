...
\begin{document}
	...
	\section{Communities}
		...
		\end{strip}
			...
			Abuja was planned in the middle of the country, being reachable by a similar travel distance from all the regions, but far away from existing rail way lines and highways.
			...
			In the Central Business District, the blocks are large, walking distances are long and pedestrian infrastructure is missing. Most of the roads and highways were planned with level-free crossings for high capacity of vehicles. 			
			...
			Only a few railway lines were planned for such a big city.
			
			
			\subsubsection{Development}
			
			The construction of the city started by constructing the Central Business District, an area with high buildings and commercial areas, and the first highway ring.
			Further phases should include a second highway ring and mostly residential oriented districts.
			...
			- 200? The railway line connecting the CBC, the main staition and the airport was finalized.
			...
			Abuja is one of the fastest growing cities in the world. It grows between 20\% and 30\% per year. Meanwhile development inside the planned area is following the master plan, slums are growing outside the planned areas. Especially these slums around Abuja and sprawling suburbs are growing uncontrolled.
			...
			Slums are also filling open areas inside the planned area and are growing fast.
			...
			The railway line to the airport counts with many stations, which are far away from the next districts. People need to walk long distances or drive to get there.
			...
			In the city center, bus lines are connecting the different parts of the CBC, but they do not stop at the official stops and are often unreliable.
			The city counts with high congestion.
