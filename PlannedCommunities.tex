...
\begin{document}
	...
	\section{Communities}
		...
		\end{strip}
			...
			- Initial stages not completed before 1980
			
			
			\begin{table}[H]			
				\centering
				\caption{Development}
				\label{table:abuja-development}
				\begin{tabular}{|l|l|}
					\hline
					\textbf{Population 2006}           & ~800'000 \\
					\hline
				\end{tabular}
			\end{table}
			...
			- 2018 The railway line connecting the CBC, the main station and the airport was finalized.
			...
			- since 2003 demolition campaigns. Tens of thousands of people have been evicted since then. 
			...
			\begin{table}[H]			
				...
				\begin{tabular}{|l|l|}
					\hline
					\textbf{Population}           & \textgreater 2.5 M \\
			...
			Abuja had a population of around 2.5 millions in 2014, and it's expected that it will grow up to 6 million people.
